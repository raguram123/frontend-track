        ...
        <div className="container py-5 h-100 ">
            <div className="row d-flex justify-content-center align-items-center h-100 ">
                <div className="col col-xl-9">
                    <h2 className='m-auto' style={{ textAlign: "center" }}>Product Details</h2>
                    <div className="card m-auto mt-3" style={{ width: "30rem" }}>
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">Manufacturer : {details.author}</li>
                            <li className="list-group-item">Stocks: {details.book_count}</li>
